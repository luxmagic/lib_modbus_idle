...
ushort usMBCRC16(uchar *pucFrame, ushort usLen) // 1параметр - фрейм; 2параметр - длина фрейма
{
    uchar ucCRCHi = 0xFF; // определение старшего байта
    uchar ucCRCLo = 0xFF; // определение младшего байта
    int iIndex;           // индекс в таблице поиска CRC
